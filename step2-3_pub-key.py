...
access_token = get_access_token('<Your-client-id-PUBLIC>',
                                '<Your-client-secret-PUBLIC>')
...
def upload_video_file(url):
    ...
    files = {'file': open(
        '/home/p.kertonugroho/KIB/API/python/upload_video/android.mov', 'rb')}
